package com.example.httpTest.onLineTest;
...
//        getFeatureCode();
    ...
    public static void upload() {
        ...
        String url = "https://hdyz.yusong.com.cn/staticserver_face/security/upload/attachment.htm";
    ...
    public static void getFeatureCode() {
        ...
        String url = String.format("https://hdyz.yusong.com.cn/staticserver_face/security/upload/get_feature_code.htm?appId=%s&signType=MD5&timestamp=%d&fileSign=%s&sign=%s", AppUtils.APP_ID, timeMillis, fileMd5, sign);
