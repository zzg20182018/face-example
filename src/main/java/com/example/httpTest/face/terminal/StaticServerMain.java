...
//        getFeatureCode();
    ...
    public static void upload() {
        ...
        String url = "http://localhost:8080/security/upload/attachment.htm";
    ...
    public static void getFeatureCode() {
        ...
        String url = String.format("http://localhost:8080/security/upload/get_feature_code.htm?appId=%s&signType=MD5&timestamp=%d&fileSign=%s&sign=%s", AppUtils.APP_ID, timeMillis, fileMd5, sign);
